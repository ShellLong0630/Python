...
for s in f:
    ...
    if sourceId in ['g1526974','g187216','g187498','g189525','g189527','g190456',
        ...
        while timebreak<10:
            timebreak+=1
            if True:#os.path.isfile('D:\\张玉龙\\Python\\landmarks\\'+sourceId+'.txt')== False:
                #随机取一个代理ip                
                ...
                try:
                    ...
                    print(sourceId,'0 ok!',timebreak)
                    print(re.findall('地标\([\d]+\)',content))
                    ...
                    print(sourceId,0,' error!',timebreak)                           
            else:
                break
        #读到content后，再读翻页
                    ...
                    if t==0:
                        ...
                        while timebreak2<4:
                            ...
                            try:
                                ...
                                landmark = re.findall('<a href="/Attraction_Review-([\S]+)" class=',content)
                                print(sourceId,t,' ok!',timebreak2,landmark)
                                #print(landmark)
                                for m in landmark:
                                    landmarks.append(m)
                                if content:
                                ...
                                print(sourceId,t,' error!',timebreak2)
        if landmarks:
            file2 = 'D:\\张玉龙\\Python\\landmarks\\'+sourceId+'.txt'
